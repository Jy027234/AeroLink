...
const rolePolicies: Record<NormalizedRole, RolePolicy> = {
  ...
  manager: combine(
    ...
    grant('department_or_own', [
      ...
      ...keys('purchase_commitment', ['read', 'create', 'update', 'transition', 'approve', 'view_cost', 'export']),
      ...keys('settlement', ['read', 'view_cost']),
    ]),
  ...
  finance: combine(
    grant('all', [
      ...
      ...keys('purchase_commitment', ['read', 'approve', 'view_cost', 'export']),
      ...keys('settlement', ['read', 'create', 'update', 'reconcile', 'export', 'view_cost']),
  ...
  sales: combine(
    ...
    grant('own', [
      ...
      ...keys('purchase_commitment', ['read']),
      ...keys('settlement', ['read']),
