...
export type AuditResourceType = 'RFQ' | 'QUOTATION' | 'ORDER' | 'INVENTORY' | 'CUSTOMER' | 'SUPPLIER' | 'CERTIFICATE' | 'SETTINGS' | 'WORKFLOW' | 'OUTBOX' | 'PURCHASE_COMMITMENT' | 'STOCK_RECEIPT' | 'SUPPLIER_DIRECT_SHIPMENT';
